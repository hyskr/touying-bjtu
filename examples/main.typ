...
#import "../lib.typ" as bjtu-theme

// cetz 和 fletcher 绑定到 touying
#let cetz-canvas = touying-reducer.with(reduce: cetz.canvas, cover: cetz.draw.hide.with(bounds: true))
#let fletcher-diagram = touying-reducer.with(reduce: fletcher.diagram, cover: fletcher.hide)

// 注册北交通主题
// 您可以将其替换为其他主题，它仍然可以正常工作
#let s = bjtu-theme.register()

// 设置章节和小节的编号
#let s = (s.methods.numbering)(self: s, section: "1.", "1.1")

// 设置演讲者备注配置，可以通过 pympress 显示
// #let s = (s.methods.show-notes-on-second-screen)(self: s, right)

// 全局信息配置
#let s = (s.methods.info)(
  self: s,
  title: [基于 Touying 的北交通 Typst 幻灯片模板],
  subtitle: [基于 Touying 的北京交通大学 Typst 幻灯片模板],
  author: [Heziah],
  date: datetime.today(),
  institution: [北京交通大学],
)
